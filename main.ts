...
//  spaces
 let personName01: string ="\t Anees Hanif \n";
...
let names: string [] = ["Anees","Habib","Faik","Uzair"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let names1: string [] = ["Anees","Habib","Faik","Uzair"];
let message3: string = "Do you like to play football";
...
let transportation : string []= ["Honda","BMW","Ferrari","Lamborghini"];
...
let guestArr: string [] = ["Anees","Habib","Faik"];
...
let countries : string[] = ["Pakistan","Saudi Arabia","UAE","USA"];
...
let person01:{name:string,fname:string,age:number}={
    name:"Mohummad Anees",
...
let users: string [] = ["Eric","Anees","Habib","Faik","admin"];
...
let users1: string [] = ["Eric","Anees","Habib","Faik","admin"];
users1 = [];
if(users1.length === 0){
...
// • Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted.
  ...
  let current_users : string [] = ["eric","Anees","Habib","Faik","admin"];
  let new_users : string [] = ["eric","Nabid","Ahmed","Asim","admin"];
...
function show_magicians(magicians : string[]): (void){
 ...
 let magician : string[] =["Anees","Habib","Eric"];
...
// see that the list has actually been modified.
 ...
 let magician2 : string[] =["Champo","pappo","tony"];
...
// names and one array with the Great added to each magician’s name.
 ...
 const magicians3: string[] = ["Tappo","Tom","Jerry"];
